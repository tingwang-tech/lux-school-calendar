    ...
    <main className="max-w-2xl mx-auto px-4 py-6 md:py-12">
      ...
      <div className="border-t border-[#D3D1C7] pt-10 mt-10">
        ...
        <p className="text-sm text-[#888780] mb-6">
          Add this to your home screen and open it like an app — no App Store needed.
        </p>
        <InstallAnimation />
      </div>

      <div className="mt-12 space-y-3">
        <p className="text-xs text-[#B4B2A9] leading-relaxed">
        ...
        <div className="relative flex items-center justify-center">
          <p className="text-xs text-[#B4B2A9]">
            © 2026 Lux School Calendar · Built by Tzu-Ting Wang with Claude
          </p>
          <a
            href="https://www.linkedin.com/in/wangtzuting/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Tzu-Ting Wang on LinkedIn"
            className="absolute right-0 text-[#B4B2A9] hover:text-[#0A66C2] transition-colors"
          >
